...
public class AdapterPhoto extends RecyclerView.Adapter<AdapterPhoto.QRViewHolder> {
    private final ArrayList<Drawable> photos;
     ...
     */
    public AdapterPhoto(ArrayList<Drawable> photos, Context ct, RecyclerClickerListener listener) {
        this.photos = photos;
        this.ct = ct;
     ...
     * @param ct Context
     */
    public AdapterPhoto(ArrayList<Drawable> photos, Context ct) {
        this.photos = photos;
        this.ct = ct;
        this.listener = null;
    }
